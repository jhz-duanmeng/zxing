package fun.unifun.zixing.android;
...
import fun.unifun.zixing.R;
import fun.unifun.zixing.bean.ZxingConfig;
import fun.unifun.zixing.camera.CameraManager;
import fun.unifun.zixing.common.Constant;
import fun.unifun.zixing.decode.DecodeImgCallback;
import fun.unifun.zixing.decode.DecodeImgThread;
import fun.unifun.zixing.decode.ImageUtil;
import fun.unifun.zixing.view.ViewfinderView;
